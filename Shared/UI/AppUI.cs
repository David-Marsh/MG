...
{
    public class AppUI : UIManager
    {
        private UIPanel appControl;
        private UIButton btnPause;
        private UIButton btnMute;
        private UIButton btnMenu;
        private UIButton btnMinimize;
        private UIButton btnNormalize;
        private UIButton btnMaximize;
        private UIButton btnFullScreen;
        ...
        public AppUI(Game game) : base(game)
        {
        }
        ...
        {
            appControl = new UIPanel(56, 0, 8, 1, Color.Transparent);

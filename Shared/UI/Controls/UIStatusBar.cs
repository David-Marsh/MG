...
{
    public class UIStatusBar : UIRectangle, IMouseControl
    {
        private bool hovering;
        private SpriteFont font;
        private string text;
        private Vector2 textPosition, textZoom;
        private Rectangle Bar, BarBox;
        private float value;
        public bool Pressed;
        ...
        public UIStatusBar(int x, int y, int width, int height, string text, Color? back = null, Color? fore = null) : base(x, y, width, height, back ?? Color.Transparent)
        {
            CanHover = true;

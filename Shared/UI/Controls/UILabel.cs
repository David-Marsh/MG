...
{
    public class UILabel : UIRectangle
    {
        ...
        public UILabel(int x, int y, int width, int height, string text, Color? back = null, Color? fore = null) : base(x, y, width, height, back ?? Color.Transparent)
        {

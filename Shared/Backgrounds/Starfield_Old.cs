...
{
  public class Starfield_Old : Background_Old
  {
    private int pass;
    private Star[] stars;
    public Starfield_Old(GraphicsDeviceManager graphics, int maskSize) : base(graphics, maskSize)
    {
    ...
    public override void OnResize(GraphicsDevice graphicsDevice)
    {
      base.OnResize(graphicsDevice);
      stars = new Star[DrawBounds.Height / CenterCell.Height * (DrawBounds.Width / CenterCell.Width)];
      DrawBoundsChanged();
    }
    ...
    public struct Star
    {
      ...
      public static int Maskbits { get; set; }

...
{
    public class UIDiagnostics : UIPanel
    {
        private UILabel lblDraw;
        private UILabel lblUpdates;
        private UILabel lblScan;

        private static readonly Stopwatch stopWatch = new();
        private static double tsUpdate;
        private static double tsDraw;

        public UIDiagnostics(int x, int y, int width, int height, Color back = default) : base(x, y, width, height, back)
        {

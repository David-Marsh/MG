...
{
    public class UIButton : UILabel, IMouseControl
    {
        ...
        public UIButton(int x, int y, int width, int height, string text, Color? back = null, Color? fore = null, bool menu = false) : base(x, y, width, height, text, back, fore)
        {
            CanHover = true;
            Menu = menu;
            Delay = 0;
